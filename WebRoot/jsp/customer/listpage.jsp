	...
	<form action="${pageContext.request.contextPath}/customer_moreCondition.action" method="post">
		...
		<table border="1px">
			<tr>
				...
				<td>客户编号</td>
				<td>
					<input type="text" name="customer.cust_no">
				</td>
				<td>地区</td>
				<td>
				<!--
					这里需要把所有的地区从数据字典表中查出来显示，查询的时候传过去的数据是id值
					可以针对数据字典表，
				-->
			...
			<tr>
				<td>客户经理/负责人</td>
				<td>
					<input type="text" name="customer.cust_manager_name">
				</td>
				<td>客户等级</td>
				<td>
			...
			<c:forEach items="${pageBean.list}" var="customer">
				<tr>
					...
					<td>
						...
						<a href="${pageContext.request.contextPath }/customer_delete.action?cust_no=${customer.cust_no}">删除</a>
					</td>
				</tr>
			</c:forEach>
		</tbody>
