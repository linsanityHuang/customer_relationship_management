...
<!--
	...
	function getDHTMLObjTop(theObj) {
		return (theBrowser.code == "MSIE") ? theObj.pixelTop : theObj.top;
	}
...
function initialise() {
	...
	L0101 = theMenu.addChild(L01, "Document", "销售机会管理", "${pageContext.request.contextPath }/saleChance_listpage.action?currentPage=1", "销售机会管理...");
	L0102 = theMenu.addChild(L01, "Document", "客户开发计划", "${pageContext.request.contextPath }/salePlan_showSalePlan.action?currentPage=1", "客户开发计划...");
